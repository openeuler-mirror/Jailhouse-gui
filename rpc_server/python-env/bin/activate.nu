...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/ft2000/workspace/resource-tool-server/python-env'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/ft2000/workspace/resource-tool-server/python-env/bin/deactivate.nu'
